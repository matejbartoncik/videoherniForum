...
if($_SERVER['REQUEST_METHOD']==='POST'){
    if(auth_login($_POST['login']??'',$_POST['password']??'')){ header('Location:/../pages/home.php'); exit; }
...
<form method="post" class="mx-auto bg-white p-4 rounded shadow-sm" style="max-width:420px">
    ...
    <div class="mt-3 text-center"><a href="/../pages/register.php">Nemáš účet? Registrace</a></div>
</form>
